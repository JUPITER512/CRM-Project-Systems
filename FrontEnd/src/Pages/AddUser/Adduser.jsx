        ...
        <div className="w-full min-h-screen bg-gray-100 p-4 md:p-6 lg:p-8 rounded-lg">
          <form className="bg-white rounded-lg shadow-md p-4 md:p-6 lg:p-8 relative">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              ...
              <div className="flex flex-col my-2">
                <label htmlFor="PrimaryPhone" className="text-sm font-semibold">
                  Primary Phone :
                </label>
                <input
                  type="text"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 my-4">
              <div className="bg-gray-200 rounded-lg p-4">
                <h3 className="text-left font-semibold text-lg mb-2">
                  Address
                </h3>
                <div className="flex flex-col gap-4">
                  <div className="flex flex-col">
                    <label htmlFor="address1" className="text-sm font-semibold">
                      Address Line 1
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="flex flex-col">
                    <label htmlFor="address2" className="text-sm font-semibold">
                      Address Line 2
                    </label>
                    <input
                      type="text"
            ...
            <button className="mx-auto bg-slate-300 w-[100%] md:w-[20%] px-6 py-2 rounded-lg shadow-lg relative left-[50%] translate-x-[-50%]">
              Add +
            </button>
          </form>
        </div>
